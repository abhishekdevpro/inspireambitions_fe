...
//           Welcome to INSPIRE AMBITIONS. These terms and conditions outline the rules and
...
//           <li>
//             Client: Any individual or entity using the services of INSPIRE AMBITIONS.
//           </li>
//           <li>Company: INSPIRE AMBITIONS.</li>
//           <li>
...
//         <ul className="list-inside list-disc pl-4 text-base sm:text-lg">
//           <li>
//             All content, materials, and services provided by INSPIRE AMBITIONS are
...
//         <ul className="list-inside list-disc pl-4 text-base sm:text-lg">
//           <li>
//             INSPIRE AMBITIONS respects the privacy and confidentiality of its clients.
//           </li>
//           <li>
...
//         <ul className="list-inside list-disc pl-4 text-base sm:text-lg">
//           <li>
//             INSPIRE AMBITIONS will not be liable for any direct, indirect, incidental,
...
//         <ul className="list-inside list-disc pl-4 text-base sm:text-lg">
//           <li>
//             INSPIRE AMBITIONS reserves the right to modify or update these terms and
...
//             accordance with the laws of the jurisdiction in which INSPIRE AMBITIONS
//             operates.
//           </li>
//           <li>
    ...
    <div>
      ...
      <div className="m-4 sm:mx-10 lg:mx-40 p-4 sm:p-6 shadow-2xl">
        ...
        <p className="text-base sm:text-lg">
          {/* {termsData.contact}: */}
          Email:{" "}
          <a href="dummy@inspireambitions.com" className="text-blue-500">
            dummy@inspireambitions.com
          </a>
        </p>
      </div>
