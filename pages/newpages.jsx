    ...
    <div className="max-w-3xl mx-auto p-6">
      ...
      <div className="bg-gray-100 p-6 rounded-lg flex items-center gap-4">
        <div>
          <h2 className="text-xl font-bold ">
            INSPIRE AMBITIONS AI Resume Builder
          </h2>
          <p className="text-gray-700 text-sm mt-2">
            Applying for jobs has never been easier! INSPIRE AMBITIONS AI is an
      ...
      <div className="flex justify-center gap-4 items-center mt-4">
        ...
        <h3 className="text-2xl font-bold text-center my-6">
          INSPIRE AMBITIONS AI INTERVIEWS
        </h3>
      ...
      <p className="text-center text-sm text-gray-600 mt-6">
        ...
        with INSPIRE AMBITIONS AI—the smarter way to build the perfect resume
