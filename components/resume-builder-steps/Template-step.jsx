...
import template31 from "../preview/template/template29.png";
      ...
      `}
          ...
          {isBasicUser && (
            <button
              ...
              className="mt-4 w-full bg-teal-600 hover:bg-teal-700 text-white text-sm font-semibold py-2 px-4 rounded-lg shadow-md transition duration-200"
            >
