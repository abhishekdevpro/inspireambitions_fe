          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {[
              ...
              <button
                ...
                className="p-5 rounded-2xl shadow-md border border-gray-200 bg-teal-200 hover:bg-teal-700 hover:text-white hover:shadow-xl flex flex-col items-center transition-all duration-200 group"
              >
                <Image
                  src={country.flag}
                  alt={country.name}
