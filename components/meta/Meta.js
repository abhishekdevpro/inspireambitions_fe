...
export default function Meta({ title, keywords, description }) {
  ...
  function organizationSchema() {
    return {
      __html: JSON.stringify({
        ...
        "@type": "Organization",
        name: "INSPIRE AMBITIONS",
        alternateName: "INSPIRE AMBITIONS",
        url: homepage,
        logo: logo,
        contactPoint: {
          "@type": "ContactPoint",
        ...
        sameAs: [
          "https://ciblijob.fr//",
          "https://www.facebook.com/people/INSPIRE AMBITIONS/61564845718534/",
        ],
      }),
    };
  }
  ...
  return (
    <Head>
      ...
      {/* Open Graph (OG) Tags */}
      <meta property="og:site_name" content="INSPIRE AMBITIONS" />
      <meta property="og:url" content={homepage} />
      <meta
        property="og:title"
        content="Best AI Resume Builder Online | INSPIRE AMBITIONS"
      />
