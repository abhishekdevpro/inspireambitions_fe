...
const FullScreenLoader = () => {
  ...
  return (
    <div className="fixed inset-0  bg-gradient-to-b from-white to-teal-200 flex items-center justify-center z-50">
      <div className="text-center max-w-md w-full px-4">
        {/* Resume Preview Card */}
        <div className="bg-white shadow-lg rounded-lg p-6 mx-auto mb-8 relative">
          {/* Blue header bar */}
          <div className="bg-teal-700 h-12 absolute top-0 left-0 right-0 rounded-t-lg"></div>
        ...
        <div className="space-y-4">
          ...
          <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
            <div className="h-full bg-teal-700 rounded-full animate-progress"></div>
          </div>
