...
import plan from "../../public/assets/plan-img.png";
  ...
  return (
    <section className=" ">
      <div className="max-w-7xl container mx-auto px-4">
        ...
        ${index === 1 ? "bg-darkBlue" : "bg-brandBlue"}`}
            >
              <div className="p-6 border-b border-gray-100">
                <div className="mb-2">
                  ...
                  <Image src={plan} alt="plan" height={50} width={80} />
                </div>
                <div className="flex items-baseline mb-1">
                  <span className="text-3xl font-bold text-white">
                    {Number(t(`pricing.${planType}.price`)) === 0
                      ? t("pricing.freeLabel")
                      : `AED${t(`pricing.${planType}.price`)}`}
                  </span>
              ...
              <div className="p-6">
                ...
                <Button
                  className="w-full mt-8 bg-white hover:bg-transparent hover:border-2 hover:border-white hover hover:text-white text-black "
