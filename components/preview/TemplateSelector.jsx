...
import template31 from "./template/template29.png";
...
import template36 from "./template/template36.png";
...
import template40 from "./template/template39.png";
import template41 from "./template/template41.png";
import template42 from "./template/template42.png";
import template43 from "./template/template43.png";
import template44 from "./template/template44.png";
...
import template51 from "./template/template51.png";
import template52 from "./template/template52.png";
...
const TemplateSelector = ({
  ...
  const allTemplates = [
    ...
    { key: "template36", imageUrl: template36, pdfType: 3 },
      ...
      {isOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/75 p-4 ">
          <div className="bg-gradient-to-b from-white to-blue-100 rounded-xl p-6 w-full max-w-5xl relative shadow-2xl ">
            ...
            <div className="text-lg font-bold mb-4 text-center border rounded-3xl py-2 text-white bg-teal-600">
              Select a Template
            </div>
